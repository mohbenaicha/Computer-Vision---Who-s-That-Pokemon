# Script for automating image collection
# NOTE: EXPRESS CONSENT FROM GOOGLE IS REQURED FOR SENDING AUTOMATED QUERIES TO GOOGLE WEBPAGES. 
# DISCLAIMER: Running this script is sends automated queries to Google's web pages.
